...
- **Libraries & Frameworks** – NumPy · NetworkX · scikit‑learn · TensorFlow · NetLogo · LaTeX  
- **Tools & Practices** – Git · Linux/Bash · HPC · Agent‑based modeling · Statistical inference · Uncertainty quantification  
